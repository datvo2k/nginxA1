...
extern uint32_t ngx_crc32_table[256];
...
typedef struct {
    ...
    unsinged header_sent:1;
    unsinged trailer_sent:1;
    unsinged missing_crc32:1;
    unsinged need_zip64:1;
    unsinged need_zip64_offset:1;
